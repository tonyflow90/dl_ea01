...
var app = (function () {
    ...
    /* src\components\BarChart.svelte generated by Svelte v3.37.0 */
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 62, 8, 1475);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$1, 54, 4, 1297);
    			attr_dev(div, "class", "chart svelte-1mvvpml");
    			attr_dev(div, "id", "chart");
    			add_location(div, file$1, 59, 4, 1414);
    			attr_dev(main, "showresult", /*showresult*/ ctx[2]);
    			attr_dev(main, "class", "svelte-1mvvpml");
    			add_location(main, file$1, 53, 0, 1261);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let draw = data => {
    		...
    		var gdata = google.visualization.arrayToDataTable([["Element", "Percentage"], ...adata]);
    		var options = { chartArea: { width: "50%" } };
    ...
    class BarChart extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*image*/ ctx[0] === undefined && !("image" in props)) {
    			console.warn("<BarChart> was created without expected prop 'image'");
    		}
    ...
    // (118:6) <Button on:click={onClassify}>
    function create_default_slot_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(118:6) <Button on:click={onClassify}>",
    		ctx
    	});
    ...
    // (125:6) <Button         color="secondary"         light         block         outlined         on:click={onReset}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(125:6) <Button         color=\\\"secondary\\\"         light         block         outlined         on:click={onReset}>",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(105:4) {#each images as image, i}",
    		ctx
    	});
    ...
    // (142:2) <Snackbar     bind:value={showSnackbar}     noAction     color={snackbarColor}     timeout={snackbarTimeout}    >
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 147, 3, 3211);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(142:2) <Snackbar     bind:value={showSnackbar}     noAction     color={snackbarColor}     timeout={snackbarTimeout}    >",
    		ctx
    	});
    ...
    // (150:4) <Button on:click={() => (showSnackbar = false)}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(150:4) <Button on:click={() => (showSnackbar = false)}>",
    		ctx
    	});
    ...
    function create_action_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 148, 3, 3236);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(button, div, null);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h5 = element("h5");
    			h5.textContent = `Einsendeaufgabe ${/*taskNumber*/ ctx[9]}`;
    			t3 = space();
    			h3 = element("h3");
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*result*/ 4) barchart_changes.image = /*result*/ ctx[2].image;
    			if (dirty & /*result*/ 4) barchart_changes.data = /*result*/ ctx[2].items;
